    ...
    <div id="wrapper" class="wrapper-content">
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li><i class="far fa-envelope-open"></i><a href="pesan_mhs.php">Kotak Pesan</a></li>
                    ...
                    <div class="col-lg-12">                    
                        ...
                        <table class="table table-striped">
                            ...
                            while($i = mysqli_fetch_array($insert)){ ?>
                                <tr>
                                    <td>
                                        <?php echo $i['nama_elearning']; ?>
                                    </td>
                                    <td>
                                        <?php echo $i['nama_dosen']; ?>
                                    </td>
                                    <td>
                                        <?php echo $i['mata_kuliah']; ?>
                                    </td>
                                    <td>
                                        <center>
                                            <?php echo $i['semester']; ?>
                                    ...
                                    <td>
                                        <CENTER>
                                            <?php  echo "<a class='btn btn-warning' href=\"../cek/download.php?file=$i[document]\">Download</a>";?>
                                            <a href="../cek/tampilkan_elearning.php" class="btn btn-primary" target="blank"
                                                class>Lihat</a></CENTER>
                                    </td>
                                </tr>
