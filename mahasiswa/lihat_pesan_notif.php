                    ...
                    <div class="dropdown show">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown01">
                            ...
                            if($i['status_notif']=='unread'){
                                echo "
                                font-weight:bold;"; } ?>
                                " class="dropdown-item" href="view.php?id=
                                <?php echo $i['id'] ?>">
                                <small><i>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        $query ="UPDATE `notifikasi` SET `status_notif` = 'read' WHERE `id_notif` = $id;";
                        performQuery($query);

                        $query = "SELECT * from `notifikasi` where `id_notif` = '$id';";
                        if(count(fetchAll($query))>0){
                            foreach(fetchAll($query) as $i){
                                if($i['type_notif']=='comment'){
                                    echo "<div class='jumbotron col-lg-12'>";
                                    echo ucfirst("<blockqoute class='blockquote'><p class='h4'>"."Dari : ".$i['nama_pengirim']).
                                    "</p><footer class='blockquote-footer'>Tanggal/Jam : ".$i['tanggal_notif']."
                                    </footer></blockqoute>"." <br/>Isi Pesan: 
                                    <br/>".$i['pesan_notif']."</div>";                
                                }else{
                    ...
                    ?><br />
                        <a class="btn btn-outline-success" href="home_mahasiswa.php">Back</a>
                    </div>
                </div>
            </div>
