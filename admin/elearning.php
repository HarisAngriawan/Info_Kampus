                ...
                <h2>E-LEARNING</h2>
                    ...
                    <table class="table table-striped">                    
                        <thead class="table-dark">
                            <tr>                             
                                <th class="scope"><center>Judul Materi</th>
                                <th class="scope"><center>Dosen Pengampu</th>
                                <th class="scope"><center>Mata Kuliah</th>
                                <th class="scope"><center>Semester</th>
                                <th class="scope"><center>Tanggal Upload</th>
                                <th class="scope"><center>Document</th>
                        ...
                        <?php $insert =mysqli_query($koneksi,"SELECT * FROM elearning");
                            ...
                            <tr>                        
                                <td><center><?php echo $i['nama_elearning']; ?></td>
                                <td><center><?php echo $i['nama_dosen']; ?></td>
                                <td><center><?php echo $i['mata_kuliah']; ?></td>
                                <td><center><?php echo $i['semester']; ?></td>
                                <td><center><?php echo $i['tanggal_upload']; ?></td>
                                <td><center><a href=""></a><?php echo $i['document']; ?></td>
                                <td><CENTER>                                
                                    <a href="" class="btn btn-outline-warning">Edit</a>
                                    <a href="cek/tampilkan_elearning.php" class="btn btn-outline-primary" target="blank" class>View</a></CENTER>
                                </td>
                            </tr>                            
                            <?php } ?>                            
                        </tbody>
