        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <h2>INFORMASI PERATURAN AMIKOM</h2>
                    <a href="insert_peraturan.php"><input type="submit" value="Tambah" class="tambah btn btn-primary"></a>
                    <table class="table table-striped">                    
                        <thead class="table-dark">
                            <tr class="scope">                             
                                <th><center>No</th>
                                <th><center>Nama Peraturan</th>
                        ...
                        <?php $masukkan =mysqli_query($koneksi,"SELECT * FROM peraturan");
                            ...
                            <tr>                        
                                <td><center><?php echo $m['id_peraturan']; ?></td>
                                <td><?php echo $m['peraturan']; ?></td>
                                <td><center><?php echo $m['data']; ?></td>
                                <td><CENTER>                                
                                    <a href="" class="btn btn-outline-danger">Hapus</a>
                                    <a href="cek/tampilkan_elearning.php" class="btn btn-outline-success" target="blank" class>Lihat</a></CENTER>
                                </td>
                            </tr>                            
                            <?php } ?>                            
                        </tbody>
